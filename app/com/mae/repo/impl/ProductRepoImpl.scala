...
import com.mae.repo.{DatabaseProvider, ProductRepo}
...
@Singleton
class ProductRepoImpl @Inject()(provider: DatabaseProvider)(implicit ec: ExecutionContext)
  extends ProductRepo {

  val logger: Logger = LoggerFactory.getLogger(this.getClass())
  private val dbConfig: DatabaseConfig[JdbcProfile] = provider.jdbcConfig
